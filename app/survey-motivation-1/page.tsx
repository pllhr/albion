...
export default function SurveyMotivation1() {
  ...
  const handleContinue = async () => {
    ...
    try {
      ...
      setTimeout(() => (window.location.href = "/survey-motivation-2"), 600);
    }
  };
  ...
  return (
    <div className="h-screen w-screen bg-[#0e1a20] text-white flex flex-col items-center justify-center gap-8">
      <div className="relative inline-flex items-center animate-[float_12s_ease-in-out_infinite]" style={{ animationDuration: '600ms' }}>
        <span className="px-4 py-2 rounded-lg border border-[#4b5c66] text-white font-medium">
          <TypewriterText text="Pode ser difícil manter a motivação..." />
        </span>
